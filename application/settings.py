...
SOCIAL_AUTH_VK_OAUTH2_KEY = config.get('oauth2', 'KEY')
SOCIAL_AUTH_VK_OAUTH2_SECRET = config.get('oauth2', 'SECRET')
...
ADMINS = (
    ('kostet19940308@gmail.com', 'Podobryanskiy Konsatantin'),
)
